...
=================================
Answers the four outstanding research-validation TODOs from the v5
architecture review:
...
All four reuse the existing synthetic-dataset generator + DatasetLoader +
...
def _det_from_record(record) -> dict:
    from evaluation.runner import _feature_to_detection
    return _feature_to_detection(record)
...
def main():
    ...
    run_any = args.ablation or args.adaptive or args.correlation or args.historical
    if not run_any:
        args.all = True
