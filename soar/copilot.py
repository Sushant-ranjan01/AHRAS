...
from utils.llm_client import call_local_llm, is_llm_configured as _llm_configured, model_name

logger = logging.getLogger("ahras.soar.copilot")

# Backward-compat alias — kept so anything importing LOCAL_LLM_MODEL from
# this module (tests, older callers) still works. Source of truth for
# config now lives in utils/llm_client.py, shared with security_intelligence.
