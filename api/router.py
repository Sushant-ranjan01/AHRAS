...
@api_router.post("/security/alert-explainer", summary="Explain why a risk score changed using the evidence chain")
async def explain_alert(req: AlertExplainerRequest):
    ...
    return engine.alert_explainer(req.alert_name, req.risk_score, live_evidence)


@api_router.post("/security/investigate-incident", summary="Create a structured incident investigation summary")
async def investigate_incident(req: IncidentInvestigationRequest):
    ...
    return engine.investigate_incident(req.src_ip, ctx)
